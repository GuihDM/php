...
//APONTAR A URL DESEJADA
curl_setopt($ch, CURLOPT_URL, "http://localhost/php/aula25/teste.php");

//curl_setopt($ch, CURLOPT_URL, "https://viacep.com.br/ws/58057275/json/");
...
curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query(array('valor1' => 'Lucas', 'valor2' => 'feio')));
